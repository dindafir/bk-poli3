<?php 
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($result->num_rows > 0) {
                if ($row['no_ktp'] == $_POST['no_ktp']) {
                    ...
                    header('Location: http://'.$_SERVER['HTTP_HOST'].'/bk_poli_baru/views/pages/auth/login-pasien.php');
                }
            } else {
    ...
    function register () {
        ...
        if (isset($_POST['submit'])) {
            ...
            header('Location: http://'.$_SERVER['HTTP_HOST'].'/bk_poli_baru/views/pages/auth/register-pasien.php');
        }
    }
?>