                        ...
                        <form class="needs-validation" action="" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="text" name="nama" class="form-control" id="validationCustom08" placeholder="Nama" required="">
                            ...
                            <div class="mb-2">
                                <label for="validationCustom09">No KTP</label>
                                <div class="input-group">
                                    <input type="password" name="no_ktp" class="form-control" id="validationCustom09" placeholder="No KTP" required="">
                                    <div class="invalid-feedback">
                                        Please provide a No KTP.
                                    </div>
                                </div>
                            </div>
                            <div class="mb-2">
                            ...
                            <div class="mb-2">
                                <label class="d-block mt-3"><a href="http://<?= $_SERVER['HTTP_HOST'] ?>/bk_poli_baru/views/pages/auth/register-pasien.php" class="btn-link">Register Pasien!</a></label>
                            </div>
                        </form>
                        <?php 
